				...
				<div class="u-clearfix u-expanded-width u-gutter-24 u-layout-wrap u-layout-wrap-1">
					<div class="row mt-3">
							...
							<div class="col-md-3 col-12">
									...
									<h1 class="u-custom-font u-text u-text-8">{{ GoogleTranslate::trans('Skala', app()->getLocale()) }}</h1>
									<h1 class="u-custom-font u-text u-text-9">{{ $project->scale }}</h1>
									<h1 class="u-custom-font u-text u-text-10">{{ GoogleTranslate::trans('Tahun Proyek', app()->getLocale()) }}</h1>
									<h1 class="u-custom-font u-text u-text-11"><a href="{{route('project-year',$project->year)}}">{{ $project->year }}</a></h1>
									<h1 class="u-custom-font u-text u-text-10">{{ GoogleTranslate::trans('Tahun Penyelesaian', app()->getLocale()) }}</h1>
									<h1 class="u-custom-font u-text u-text-11"><a href="{{route('project-year',$project->year)}}">{{ $project->completion_year }}</a></h1>
