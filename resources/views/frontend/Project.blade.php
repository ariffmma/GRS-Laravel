                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      ...
                      <li><a class="filter-items" href="{{route('project-year',2010)}}">2010</a></li>
							...
							<!-- <div class="u-container-style u-hidden-md u-hidden-sm u-hidden-xs u-layout-cell u-size-11-lg u-size-11-xl u-size-60-md u-size-60-sm u-size-60-xs u-layout-cell-1">
								<div class="u-container-layout u-container-layout-1">
									<h1 class="u-custom-font u-text u-text-1"><a href="{{route('project')}}">All</a></h1>
                  @foreach($categories as $categori)
									<h1 class="u-custom-font u-text u-text-2"><a href="{{route('project-categori',$categori->cate_slug)}}">{{ GoogleTranslate::trans( $categori->name , app()->getLocale()) }}</a></h1>
									@endforeach
								</div>
							</div> -->
                    ...
                    @foreach($projects as $project )
											<div class="u-container-style u-list-item u-repeater-item">
												<div class="u-container-layout u-similar-container u-valign-top u-container-layout-3">
													<img data-href="{{route('project-detail', ['category' => $project->cate_slug, 'slug' => $project->slug])}}" class="u-expanded-width u-image u-image-default u-image-1" src="{{asset('images/'.$project->thumb)}}" alt="" data-image-width="1612" data-image-height="1029" >
													<h3 class="u-custom-font u-text u-text-10"> {{ $project->title }}</h3>
													<h6 class="u-custom-font u-text u-text-grey-50 u-text-11"><a href="{{route('project-year',$project->year)}}">{{ $project->year }}</a> - Rumah Sakit <br>{{$project->location}} </h6>
												</div>
											</div>
                    @endforeach  
