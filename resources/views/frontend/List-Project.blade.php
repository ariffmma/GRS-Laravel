...
<body class="u-body u-overlap u-xl-mode" data-lang="en">
		...
		<section class="u-clearfix u-section-2" id="sec-d340">
            ...
            <div class="u-container-style u-hidden-md u-hidden-sm u-hidden-xs u-layout-cell u-size-11-lg u-size-11-xl u-size-60-md u-size-60-sm u-size-60-xs u-layout-cell-1">
                  ...
                  <div class="">
                    <a href="{{ route('list-project')}}" class="btn-filter dropdown-toggle" type="button" >
                      All Project
                    </a>
                  </div>
                  <div class="dropdown">
                  ...
                  @foreach($categories as $categori)
                    ...
                    <div class="row">
                      <div class="col-md-4 col-sm-6 col-12 mb-2">
                        <div class="u-text-10" style="margin: 0 0 0 !important">RS EMC Pertamina Sentul City</div>
                        <div class="u-text-11" style="margin: 0 0 10px !important">2011 - Rumah Sakit <br>Sentul, Bogor</div>
                      </div>
                      <div class="col-md-4 col-sm-6 col-12 mb-2">
                        <div class="u-text-10" style="margin: 0 0 0 !important">RS EMC Pertamina Sentul City</div>
                        <div class="u-text-11" style="margin: 0 0 10px !important">2011 - Rumah Sakit <br>Sentul, Bogor</div>
