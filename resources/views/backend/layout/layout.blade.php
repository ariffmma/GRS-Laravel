    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('projects.index')}}" class="nav-link @if(Request::segment(1) === 'projects') active @endif">
          ...
          <li class="nav-item">
            <a href="{{route('backend-news.index')}}" class="nav-link @if(Request::segment(1) === 'backend-news') active @endif">
          ...
          <li class="nav-item">
            <a href="{{route('subscriber.index')}}" class="nav-link @if(Request::segment(1) === 'subscriber') active @endif">
          ...
          <li class="nav-item ">
            <a href="#" class="nav-link @if(Request::segment(1) === 'contacts' || Request::segment(1) === 'contacts-firm') active @endif">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('contacts.index')}}" class="nav-link @if(Request::segment(1) === 'contacts') active @endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Business</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('contacts-firm.index') }}" class="nav-link @if(Request::segment(1) === 'contacts-firm') active @endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Firm</p>
                </a>
              </li>
